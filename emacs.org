...
#+begin_src  emacs-lisp :tangle yes
     (if (eq system-type 'gnu/linux)
       (set-face-attribute 'default nil :font "JetBrainsMonoNL Nerd Font" :height 250)
       (set-face-attribute 'fixed-pitch nil :font "JetBrainsMonoNL Nerd Font" :height 250)
       (set-face-attribute 'variable-pitch nil :font "OpenSans" :height 250)
       )
#+end_src
